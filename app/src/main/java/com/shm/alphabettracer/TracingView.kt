...
//        strokesBitmap = Bitmap.createBitmap(w.coerceAtLeast(1), h.coerceAtLeast(1), Bitmap.Config.ARGB_8888)
...
class TracingView @JvmOverloads constructor(
    ...
    private val errorBgColor = Color.parseColor("#FFCDD2") // light red
    ...
    private fun isInsideLetter(x: Float, y: Float): Boolean {
        ...
        // Check a small square around the finger to account for stroke width
